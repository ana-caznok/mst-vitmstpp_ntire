...
python train_cw.py --method vitmstpp_pad  --pretrained_model_path /mnt/datassd/mst_toolbox/mst-vitmstpp_ntire/train_code/exp/vitmstpp_pad-exp4_cw/2024_07_09_12_01_58/net_151epoch.pth --batch_size 2 --end_epoch 25 --init_lr 4e-4 --outf ./exp/vitmstpp_pad-exp4_cw/ --data_root ../dataset/  --patch_size 482 --stride 15  --gpu_id 0

python train_cw.py --method vitmstpp_pad  --pretrained_model_path /mnt/datassd/mst_toolbox/mst-vitmstpp_ntire/train_code/exp/vitmstpp_pad-exp4/2024_06_19_10_40_25/net_92epoch.pth --batch_size 2 --end_epoch 50 --init_lr 4e-4 --outf ./exp/vitmstpp_pad-exp4_cw/ --data_root ../dataset/  --patch_size 482 --stride 15  --gpu_id 0
