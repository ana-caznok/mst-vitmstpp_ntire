...
python train_cw.py --method vitmstpp_pad  --batch_size 2 --end_epoch 100 --init_lr 4e-4 --outf ./exp/vitmstpp_pad-exp4_cw/ --data_root ../dataset/  --patch_size 482 --stride 8  --gpu_id 0 --wandb True